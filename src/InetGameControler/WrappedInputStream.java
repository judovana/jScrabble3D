...
/**
 * This input stream works in conjunction with the WrappedOutputStream to
 * introduce a protocol for reading arbitrary length data in a uniform way.
 * <p>
 * <strong>Note:</strong> See the javadoc for WrappedOutputStream for more
 * information.
 *
...
public class WrappedInputStream
 ...
 //
    ...
    /**
     * Data input stream. This stream is used to input the block sizes from the
     * data stream that are written by the WrappedOutputStream.
     * <p>
     * <strong>Note:</strong> The data input stream is only used for reading the
     * byte count for performance reasons. We avoid the method indirection for
     * reading the byte data.
     */
 ...
 // NOTE: This condition should not happen. The end of
    ...
    /**
     * Closes the input stream. This method will search for the end of the
     * wrapped input, positioning the stream at after the end packet.
     * <p>
     * <strong>Note:</strong> This method does not close the underlying input
     * stream.
     *
     * @throws java.io.IOException
     */
